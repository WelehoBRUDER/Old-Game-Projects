...
function GuildCreate() {
    let n = Math.floor(Math.random() * (30 - 10) + 10);
    for(let i = 0; i<n; i++) {
        QuestDifficulty = 0;
        let enemyType = Math.floor(Math.random() * (7 - 1) + 1);
        let enemyText = enemyType;
        evalEnemyType();
        let amount = Math.floor(Math.random() * (24 - 1) + 1);
        let adjN = Math.floor(Math.random() * (adj.length - 0) + 0);
        let namN = Math.floor(Math.random() * (Names.length - 0) + 0);
        ...
        function evalEnemyType() {
            ...
            enemyType = enemyType == 6 ? enemyType = "spirit" : enemyType;
            ...
            enemyText = enemyText == 5 ? enemyText = "Skeleton" : enemyText;
            enemyText = enemyText == 6 ? enemyText = "Spirit" : enemyText;
        }
        function evalEnemyDif() {
            ...
            QuestDifficulty = enemyType == "spirit" ? QuestDifficulty + 5 : QuestDifficulty;
        }
        function setTier() {
