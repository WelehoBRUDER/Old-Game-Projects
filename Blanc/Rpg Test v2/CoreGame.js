...
function Powers() {
    if (!open) {
        ...
        document.getElementById('combatS1').style.display = 'none';
        document.getElementById('combatS2').style.display = 'none';
        open = false;
    }
}
function Spells() {
    if (!open) {
        ...
        if (int > 9) {
            document.getElementById('combatS2').style.display = 'block';
            document.getElementById('combatS2').title = `Mana cost: ${spells[1].MPc}`
        }
        document.getElementById('combatP1').style.display = 'none';
        document.getElementById('combatP2').style.display = 'none';
        open = true;
