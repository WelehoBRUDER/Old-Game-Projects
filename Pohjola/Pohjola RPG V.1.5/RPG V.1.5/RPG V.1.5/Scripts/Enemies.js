...
function Abomination() {
    ...
    afbn = 0;
    efbn = 0;
    EnemName = 'Horrid Abomination';
    canIncrease = true;
    EnemyStats.maxHealth = 25000;
    EnemyStats.health = EnemyStats.maxHealth;
    PlayerStats.mana = PlayerStats.maxMana;
    EnemyStats.trudef = 0.45;
    EnemyStats.dmg = 850;
    EnemyStats.res = 0.4;
    PlayerStats.health = PlayerStats.maxHealth;
    document.getElementById('enemyname').textContent = 'Horrid Abomination';
    FIGHT = true;
    espeed = 39;
    clearInterval(timer2);
    timer2 = setInterval(fillBar2, espeed);
...
function SetEnemyPortrait() {
    ...
    document.getElementById('en20').style.display = 'none';
    if (EnemyType == 1) {
        ...
        document.getElementById('en20').style.display = 'block';
    }
